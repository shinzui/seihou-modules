...
- `docs.site-name` (required)
- `docs.github-user` (required)
- `docs.github-branch` (required)
- `docs.font-family` (required)
- `docs.font-basename` (required)
- `docs.font-flake` (required)
- `docs.font-package` (required)
