...
in      S.Module::{
        ...
        , prompts =
          ...
          , S.Prompt::{
            , var = "nix.treefmt"
            , text =
                "Include treefmt-nix for code formatting (fourmolu, nixpkgs-fmt, cabal-gild)?"
            }
          , S.Prompt::{
            , var = "nix.pre-commit"
