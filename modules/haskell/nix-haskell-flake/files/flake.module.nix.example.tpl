...
{ inputs, ... }:
{
  ...
  perSystem = { self', pkgs, config, ... }: {
    ...
    #       config = {
    #         Cmd = [ "${self'.packages.default}/bin/{{project.name}}" ];
